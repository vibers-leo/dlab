    ...
    <div className="min-h-screen bg-[#020617] text-slate-300">
      <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3 text-base text-slate-300 leading-relaxed">
            <p>① 회사는 정보통신설비의 보수점검, 교체 및 고장 등의 사유가 발생한 경우 서비스를 일시적으로 중단할 수 있습니다.</p>
            <p>② 천재지변, 비상사태 등으로 정상적인 서비스 제공이 불가능할 경우 서비스를 제한하거나 중단할 수 있습니다.</p>
          </div>
        </section>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-white mb-4">제7조 (저작권의 귀속 및 이용제한)</h2>
          <div className="space-y-3 text-base text-slate-300 leading-relaxed">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-white mb-4">제8조 (분쟁해결)</h2>
          <div className="space-y-3 text-base text-slate-300 leading-relaxed">
        ...
        <section className="mb-10 pt-8 border-t border-slate-700/50">
