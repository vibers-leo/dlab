      ...
      <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        <section className="mb-10">
          <p className="text-base text-slate-300 leading-relaxed">
            계발자들(Vibers)(이하 &quot;회사&quot;)은 정보주체의 자유와 권리 보호를 위해 「개인정보 보호법」 및 관계 법령이 정한 바를 준수하여, 적법하게 개인정보를 처리하고 안전하게 관리하고 있습니다. 이에 「개인정보 보호법」 제30조에 따라 정보주체에게 개인정보 처리에 관한 절차 및 기준을 안내하고, 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
          </p>
        </section>

        <section className="mb-10">
          <h2 className="text-2xl font-bold text-white mb-4">제1조 (개인정보의 처리 목적)</h2>
          <div className="space-y-3 text-base text-slate-300 leading-relaxed">
            ...
            <p className="mt-4 p-4 bg-slate-800/50 rounded-xl text-sm text-slate-400">
              본 서비스는 정적 웹사이트로 운영되며, 별도의 개인정보를 직접 수집하지 않습니다.
            </p>
          </div>
        </section>

        <section className="mb-10">
          <h2 className="text-2xl font-bold text-white mb-4">제2조 (개인정보의 처리 및 보유기간)</h2>
          <div className="space-y-3 text-base text-slate-300 leading-relaxed">
            <p>회사는 법령에 따른 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.</p>
            <div className="mt-4 p-4 bg-slate-800/50 rounded-xl">
              <h3 className="text-base font-bold text-white mb-3">자동 수집 항목</h3>
              <div className="space-y-2 text-sm">
                <div>
                  <p className="font-semibold text-slate-300">• 서비스 이용 기록</p>
                  <p className="ml-4 text-slate-500">보유기간: 3개월 (통신비밀보호법 준수)</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-white mb-4">제3조 (처리하는 개인정보의 항목)</h2>
          <div className="space-y-3 text-base text-slate-300 leading-relaxed">
            <div className="mt-4 p-4 bg-slate-800/50 rounded-xl">
              <h3 className="text-base font-bold text-white mb-2">자동 수집 항목</h3>
              <p className="text-sm text-slate-400">• IP 주소, 쿠키, 서비스 이용 기록, 방문 일시</p>
              <p className="text-sm text-slate-500 mt-2">※ 본 서비스는 회원가입 및 로그인 기능이 없으며, 이용자의 개인정보를 직접 수집하지 않습니다.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 p-4 bg-slate-800/50 rounded-xl">
            <p className="text-sm text-slate-400">현재 개인정보 처리 위탁 업체 없음</p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3 text-base text-slate-300 leading-relaxed">
            ...
            <ul className="list-decimal list-inside space-y-2 ml-4">
              <li>기술적 조치: 접근권한 관리, 접근통제시스템 설치, 보안프로그램 설치</li>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 p-6 bg-slate-800/50 rounded-xl">
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 space-y-3">
            <div className="p-4 bg-slate-800/50 rounded-xl">
              ...
              <p className="text-sm text-slate-400">전화: 1833-6972 | 홈페이지: www.kopico.go.kr</p>
            </div>
            <div className="p-4 bg-slate-800/50 rounded-xl">
              <p className="font-semibold text-white">개인정보침해신고센터</p>
              <p className="text-sm text-slate-400">전화: (국번없이) 118 | 홈페이지: privacy.kisa.or.kr</p>
            </div>
            <div className="p-4 bg-slate-800/50 rounded-xl">
              <p className="font-semibold text-white">대검찰청 사이버범죄수사단</p>
              <p className="text-sm text-slate-400">전화: 1301 | 홈페이지: www.spo.go.kr</p>
            </div>
            <div className="p-4 bg-slate-800/50 rounded-xl">
              <p className="font-semibold text-white">경찰청 사이버안전국</p>
              <p className="text-sm text-slate-400">전화: (국번없이) 182 | 홈페이지: cyberbureau.police.go.kr</p>
            </div>
          </div>
        </section>
