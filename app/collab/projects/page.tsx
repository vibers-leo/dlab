    ...
    <main style={{ fontFamily: "'Paperlogy', sans-serif", backgroundColor: '#051226', minHeight: '100vh' }}>
      <div className="border-b border-white/8" style={{ backgroundColor: 'rgba(4,14,30,0.6)' }}>
        <div className="max-w-5xl mx-auto px-6 py-5 flex items-center justify-between">
          <div>
            <h1 className="text-lg font-extrabold text-white" style={{ letterSpacing: '-0.02em' }}>프로젝트</h1>
            <p className="text-xs text-white/30 mt-0.5">엔티티 간 협업 프로젝트 관리</p>
          </div>
          <Link href="/collab/projects/new" className="px-3 py-1.5 text-xs font-bold bg-blue-500 text-white rounded-lg hover:bg-blue-400 transition-colors">
            + 프로젝트 생성
          </Link>
        </div>
      </div>
